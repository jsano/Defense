...
public class Constants : MonoBehaviour
{
    ...
    readonly static public Vector3 CASTLEPOS = Camera.main.ScreenToWorldPoint(new Vector3(200, Camera.main.pixelHeight / 4, 0));

    readonly static public float ALLYX = CASTLEPOS.x - 3;
    
    readonly static public float GROUNDY = CASTLEPOS.y;
    
    readonly static public float AIRY = Camera.main.ScreenToWorldPoint(new Vector3(0, Camera.main.pixelHeight * 3 / 4, 0)).y;
